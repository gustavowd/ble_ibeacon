...
#define ESP_UUID    {0xFE, 0xA5, 0x06, 0x93, 0xA4, 0xE2, 0x4F, 0xB1, 0xAF, 0xCF, 0xC6, 0xEB, 0x07, 0x64, 0x78, 0x25}
...
typedef struct {
    ...
    uint8_t type;
    uint8_t adv_data[2];
}__attribute__((packed)) esp_ble_ibeacon_device_name_t;


typedef struct {
    esp_ble_ibeacon_head_t ibeacon_head;
    esp_ble_ibeacon_vendor_t ibeacon_vendor;
    esp_ble_ibeacon_device_name_t device_name;
