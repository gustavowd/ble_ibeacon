...
esp_ble_ibeacon_device_name_t ibeacon_common_device_name = {
...
esp_err_t esp_ble_config_ibeacon_data (esp_ble_ibeacon_vendor_t *vendor_config, esp_ble_ibeacon_t *ibeacon_adv_data){
    ...
    memcpy(&ibeacon_adv_data->device_name, &ibeacon_common_device_name, sizeof(esp_ble_ibeacon_device_name_t));
